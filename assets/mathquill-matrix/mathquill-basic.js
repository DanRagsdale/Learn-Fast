...
(function () {
    ...
    var Matrix = /** @class */ (function (_super) {
        ...
        function Matrix(leftParentheses, rightParentheses, environment) {
            ...
            _this.parentheses = { left: '[', right: ']' };
            _this.blocks = [];
            _this.rowSize = 0;
            _this.ariaLabel = 'matrix';
            _this.parentheses = {
    ...
    var MatrixCell = /** @class */ (function (_super) {
        ...
        function MatrixCell(row, parent, replaces) {
            ...
            if (parent instanceof Matrix) {
                _this.adopt(parent, parent.getEnd(R), 0);
            }
            if (replaces) {
                for (var i = 0; i < replaces.length; i++) {
                    replaces[i].children().adopt(_this, _this.ends[R], 0);
                }
            }
            return _this;
        }
        MatrixCell.prototype.deleteOutOf = function (dir, cursor) {
            ...
            if (this.parent instanceof Matrix) {
                this.parent.backspace(this, dir, cursor, function () {
                    return _super.prototype.deleteOutOf.call(_this, dir, cursor);
                });
            }
        };
